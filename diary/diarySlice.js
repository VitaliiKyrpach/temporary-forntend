...
const diarySlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      ...
      .addMatcher(
        isAnyOf(
          fetchAllDiary.pending,
          fetchAllDiary.rejected,
          addProductDiary.pending,
          addProductDiary.rejected,
          deleteProductDiary.pending,
          deleteProductDiary.rejected,
          addExercisesDiary.pending,
          addExercisesDiary.rejected,
          deleteExercisesDiary.pending,
          deleteExercisesDiary.rejected
        ),
        handlePending
      )
      .addMatcher(
